...
import gestioneGarageArray.Main;
...
public class Garage {
	...
	public Boolean checkPostiVuoti() {
		// Metodo richiamato nel main per verifiare se ci sono posti disponibili nel garage prima di sostituire un veicolo.
		// Infatti... prima verifico se c'è un posto disponibile nel garage, nel caso ci fosse sposto l'auto che occupa la posizione, al primo posto disponibile.
		// E poi inserisco nella posizione appena liberatasi il veicolo appena creato.
	...
	public void rimuoviVeicolo(Integer posVeicolo) {
		...
		for(Veicolo v : veicoli) 
		{
			...
			{
				if(v == null)								// Se la posizioen inserita dall'utente è libera...
				{
	...
	public void visualizzaGarage() {
		...
		{
			System.out.println(Main.TEXT_RED + " ERRORE: IL GARAGE E' VUOTO!" + Main.TEXT_RESET);
		}
