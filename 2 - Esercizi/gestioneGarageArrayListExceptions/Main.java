		...
		do {
			...
			switch (sceltaMenu) 
			{
				...
				case 1:
					try
					{
						garage.controllaPostiVuoti();									// Controllo prima se ci sono posti vuoti o meno.
																						// Se si continuo con la normale esecuzione del programma.
					...
					catch(GaragePienoException e)
					{
						System.out.println(TEXT_RED + " ERRORE: IL GARAGE E' PIENO, NON PUOI AGGIUNGERE ALTRI VEICOLI!" + TEXT_RESET);
					}
					break;
				...
				case 3:					
					try {
						garage.controllaGarageSeVuoto();									// Controllo prima se ci sono posti vuoti o meno.
																						// Se si continuo con la normale esecuzione del programma.
					...
					} catch(GarageVuotoException e) {
						System.out.println(TEXT_RED + " ERRORE: IL GARAGE E' VUOTO, NON C'E' NESSUN VEICOLO DA ESTRARRE" + TEXT_RESET);
					}
					break;
